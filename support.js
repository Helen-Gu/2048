//(0.18 *4 + 0.04 * 5 = 0.92)
document_width = window.screen.availWidth;  //widthe of screen
grid_container_width = 0.92 * document_width;   //width of grid board
cell_side_length = 0.18 * document_width;   //size of tile
cell_space = 0.04 * document_width; //distance between cells
